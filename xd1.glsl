...
*/
    ...
    void main() { //Beginning of program
      ...
      for(int l=0; l<4; l++){ //Loop on the 4 layers 
        if(u_layer_enabled[l]!=1)continue;//Continue loop on layers if this layer is not visible ...
        ...
        float lzoom=u_pvals[2*l+1][0];
        vec2 screen_center = u_screen/2.0;
        vec2 image_tex_center = u_layer_range[l]/2.0;
