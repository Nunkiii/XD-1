...
(function() {
	...
	function Parser(arg, callback, opts) {
		...
		if(this.arg instanceof ArrayBuffer){
		    ...
		    console.log(" FITSJS FOUND ARRAYBUFFER!" + _this.length);
		    _this.readNextBlock = this._readBlockFromBuffer;
		    console.log(" FITSJS FOUND ARRAYBUFFER!" + _this.length);
		    _this.invoke(callback, _this.opts);
		    console.log(" FITSJS FOUND ARRAYBUFFER!" + _this.length);
		    return _this.readFromBuffer();
		}else{
		    console.log("FITSJS Reading as FILE! " + typeof(this.arg));
	...
	Parser.prototype.readBlock = function(block) {
		...
		if (arr[rowIndex] === 69 && arr[rowIndex + 1] === 78 && arr[rowIndex + 2] === 68 && arr[rowIndex + 3] === 32) {
		    ...
		    console.log("Added HDU N="+this.hdus.length);
